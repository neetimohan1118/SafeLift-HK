            ...
            {filtered.map((doc) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-xl border border-sl-border hover:border-sl-orange/30 hover:shadow-sm transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sl-orange/30"
                >
                  <div className="p-5">
                    {/* Type Badge + Status */}
